...
echo "czy zmienna ost istnieje ".$idZapisz;
...
//ZAPISUJEMY ZMIENIONE NADGODZINY
    ...
    if(isset($idZapisz)){//najpierw sprawdzamy czy zmienna istnieje
        echo "tutaj dochodzi";
                echo "<br>id do zapisu".$idZapisz;
                echo "<br>godzina do zapisu".$godzinaq;
...
//                              echo "<td><input type=\"text\" class=\"wysrodkuj\" name=\"data[]\" placeholder=\"$r->ostatnie\" value=\"$r->ostatnie\" pattern=\"(0[1-9]|1[0-9]|2[0-9]|3[01])-(0[1-9]|1[012])-[0-9]{4}\" required=\"true\" size=\"10\"></td>"; /*wyswietlamy edycje daty jednak nie koniecznie*/ 
                        ...
                        echo "<td>$r->termin</td>"; /*wyswietlamy do kiedy mamy czas wykorzystać nadgodziny*/
                            if (isset($idEdytuj) && $idEdytuj==$r->idNadgodziny OR $zaznaczone[$liczEdytuj]==$r->idNadgodziny){
                                ...
                                echo "<input type=\"hidden\" name=\"strona\" value=\"$dousuniecia\"/>"; /*przesylamy numer */
